If you want to run k-fold cross validation use the script `run_k_colf_CV.py`, if you want to use a predetermined division of data use `run_pre_divided_train_validation.py`.
